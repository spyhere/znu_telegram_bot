...
class Answers(Enum):
    ...
    NO_ATTACHMENTS = "Ви повинні додати <b>відео файл(и)</b> з підписом(<b>автор</b>, <b>назва твору</b>)."
    NO_CAPTION = "Кожен відеофайл повинен бути підписаний: <b>автор</b>, <b>назва твору</b>"
    ...
    NO_INTEREST = "Ви повинні додати <b>відео файл(и)</b> з підписом(<b>автор</b>, <b>назва твору</b>)."
